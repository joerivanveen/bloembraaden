...
class Handler extends BaseLogic
{
    ...
    public function View()
    {
        ...
        if (defined('OUTPUT_JSON')) {
            ...
            $csp = "frame-ancestors 'none';default-src 'self' https://player.vimeo.com https://www.youtube-nocookie.com https://www.youtube.com https://www.google.com; script-src 'self' 'nonce-$out->nonce'; connect-src 'self' https://www.google-analytics.com; img-src 'self' " . Setup::$CDNROOT . " www.googletagmanager.com https://www.google-analytics.com data:;font-src 'self' https://fonts.gstatic.com https://*.typekit.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://*.typekit.net;base-uri 'self';form-action 'self';";
